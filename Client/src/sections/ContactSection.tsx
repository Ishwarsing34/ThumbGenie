...
export default function ContactSection() {
    return (
        <div className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle
                text1="Contact"
                text2="Let’s Talk Thumbnails"
                text3="Have a question, feature request, or need help creating high-converting thumbnails? Drop us a message and we’ll get back to you fast."
            />
